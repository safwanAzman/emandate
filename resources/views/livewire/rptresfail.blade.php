<div class="container px-6 mx-auto grid">
    <div class="rounded-lg main-content flex-1 bg-gray-50 mt-12 md:mt-2 pb-24 md:pb-5">
        <div class="relative">
             <x-general.title-header title="Senarai Maklumat Laporan Transaksi (Gagal)" />
            <a href="{{ route('report.resfail')}}" class="text-blue-700 absolute top-0 right-0 mx-2 my-2 rounded-md bg-white py-1 px-1 flex items-center">
        ...
        <div class="container">
            <div class="flex justify-start p-4 max-w-md">
                <x-form.search-input label="Carian No Akaun / Kad Pengenalan" wire:model="findrptresfail"/>
            </div>
