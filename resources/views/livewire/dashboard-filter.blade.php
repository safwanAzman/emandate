<div class="container px-6 mx-auto grid">
    <div class="rounded-lg main-content flex-1 bg-gray-50 ">			
        ...
        @if (session()->get('authenticatedUser')['branch_type'] == 'HQ' && session()->get('authenticatedUser')['state_code'] == 00 )
    ...
    {{-- new --}}
        @elseif (session()->get('authenticatedUser')['branch_type'] == 'STA' && session()->get('authenticatedUser')['state_code'] != 00 )
        ...
        <div class="container bg-white ">
            <x-general.grid mobile="1" gap="5" sm="1" md="2" lg="2" xl="2" class="col-span-6 p-6">
                ...
                <div>
                    <label for="country" class="block text-sm font-medium text-gray-700"> Negeri </label>
                    <p  class="mt-1 block w-full py-2 px-3 border 
                    border-gray-300 bg-white rounded-md shadow-sm focus:outline-none">
                    {{ session()->get('authenticatedUser')['state_name'] }}</p>
                </div>
                <!-- End Negeri Dropdown -->

                <!-- Start Cawangan Dropdown -->
                <div>
                    <label class="block text-sm font-medium text-gray-700"> Cawangan </label>
                    <select id="city" autocomplete="city" wire:model="city"
                        class="mt-1 block w-full py-2 px-3 border 
                        border-gray-300 bg-white rounded-md shadow-sm focus:outline-none">
                        <option selected>Pilih Cawangan</option>
                        <option value='All' selected>SEMUA</option>
        ...
        {{-- @else --}}
        @elseif (session()->get('authenticatedUser')['branch_type'] == 'BRN' && session()->get('authenticatedUser')['state_code'] != 00 )
