    ...
    <div class="container px-6 mx-auto grid">
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="bg-blue-800 p-2 shadow text-xl text-white flex justify-between items-center">
                <h3 class="font-bold pl-2">Senarai Maklumat Permohonan ENRP </h3>
                        ...
                        <div class="flex justify-between">
                            <div class="inline-flex border rounded w-7/12 px-2 lg:px-6 h-12 bg-transparent">
                                <div class="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                                    ...
                                    type="text"
                                    placeholder="Carian Tarikh Permohonan / No Akaun"
                                    aria-label="Search"
                                        ...
                                        <td class="px-4 py-4 border border-indigo-dark font-semibold">
                                            <div class = "flex-grow">
                                                <div class="text-sm leading-5 text-gray-800 text-black-500">
                                                   Negeri: &nbsp;&nbsp; <i><input value = "{{ $item->description }}" disabled = true/></i>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4 border border-indigo-dark font-semibold">
                                            <div class = "flex-grow">
                                                <div class="text-sm leading-5 text-gray-800 text-black-500">
                                                    Cawangan: &nbsp;&nbsp; <i><input value = "{{ $item->branch_name }}" disabled = true/></i>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
