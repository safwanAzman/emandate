...
<div class="container px-6 mx-auto grid">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
      ...
      <div class="bg-blue-800 p-2 shadow text-xl text-white">
          <h3 class="font-bold pl-2">Bilangan Permohonan Lulus Mengikut Negeri</h3>
      </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusJhr->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusKdh->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusKltn->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusMlk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusN9->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusPhg->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusPrk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusPrls->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusPP->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusSbh->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusSrwk->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusSlngr->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusTrg->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                              ...
                              <div class="flex flex-row items-center">
                                    <div class="flex-1 text-right md:text-left">
                                          ...
                                          <h3 class="font-bold text-2xl"> {{($lulusKl->count())}} 
                                    </div>
                              </div>      
                        </div>
                  </div>
